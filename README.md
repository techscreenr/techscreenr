...
### Production Mode Bug
Currently there is a bug [Unknown error from PostCSS plugin... #155](https://github.com/DavideViolante/Angular-Full-Stack/issues/155). In order to fix the issue follow the instructions in the URL just mentioned.
